function [] = compileActivityFilesV2(data)
   ...
   % if k > 1, continue;end    %for debugging
    ...
    parfor z = 1:numWells
        ...
        try
            ...
            summaryRow = table(scan_runID, assayColumn, scan_div, wellID, {neuronType}, hd5Date, {scan_chipID}, ...
            ...
            nestedDistTable = table(scan_runID,assayColumn, scan_div, wellID, {neuronType}, {scan_chipID}, ... % Add identifiers

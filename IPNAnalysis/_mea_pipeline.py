...
# When imported as `MEA_Analysis.IPNAnalysis._mea_pipeline`, we avoid
...
class MEAPipeline:
    ...
    def run_preprocessing(self):
        ...
        # NOTE: I'm not 100% sure because its a bit annoying to test, but running this with local_radius (250, 250) may be failing every time.

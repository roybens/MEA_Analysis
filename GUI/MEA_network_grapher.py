...
data_f = '/mnt/disk15tb/mmpatil/Spikesorting/Data/Compiled/Compiled_Networks.csv'
reference_f = '/mnt/disk15tb/mmpatil/Spikesorting/Data/Compiled/Copy of MEA Primary Neuron Assays.xlsx'
#set exclude lists
chip_exclude = []
run_exclude = []
div_exclude = 27
#set plot saving dir
opt_dir = '/mnt/disk15tb/mmpatil/Spikesorting/Data/Compiled/MEA_graphs/'

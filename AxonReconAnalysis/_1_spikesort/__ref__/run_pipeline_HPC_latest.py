...
#print rank of this python instance
# from mpi4py import MPI #TODO: Update axonkilo_docker to include mpi4py
# comm = MPI.COMM_WORLD
# rank = comm.Get_rank()
# print(f'Rank: {rank}')

# #check GPUs allocated to this python instance running on slurm srun command
# import os
# os.system('nvidia-smi')

# #check cores allocated to this python instance running on slurm srun command
# import multiprocessing
# print(f'Number of cores allocated to this python instance: {multiprocessing.cpu_count()}')

# #check memory allocated to this python instance running on slurm srun command
# import psutil
# print(f'Allocated memory: {psutil.virtual_memory()}')

# #check disk space allocated to this python instance running on slurm srun command
# import shutil
# print(f'Allocated disk space: {shutil.disk_usage("/")}')
...
project_dirs = [
    ...
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241004', #spike sorted
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241007', #spike sorted
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241010', #spike sorted
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241014', #spike sorted
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241017', #spike sorted
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241021', #spike sorted
    #'/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241022', #spike sorted
    '/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241024',    
    '/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241028', 
    '/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241030',
    '/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241031',
    '/pscratch/sd/a/adammwea/workspace/xInputs/xRBS_input_data/B6J_DensityTest_10012024_AR/241104',
]

output_dir = '/pscratch/sd/a/adammwea/workspace/yThroughput/zRBS_axon_reconstruction_output'

# # #comment out the following line if running on HPC
# sys.argv = [
#     'run_pipeline_HPC_latest.py',  # Script name
#     '--stream_select', '0'
# ]
    ...
    for plate_file in h5_file_paths:    
        ...
        for stream_select in [0, 1, 2, 3, 4, 5]:
            try:
                ...
                kwargs['only_load_sortings'] = False
...
if __name__ == "__main__":
    run_pipeline_on_project_dirs(project_dirs, output_dir)

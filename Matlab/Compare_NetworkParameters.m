function [output_arg] = Compare_NetworkParameters(fileDir, refDir, outDir, parameter, varargin)
    ...
    if ismember(runID,asssy_runIDs)
        ...
        for k = parameter_start:parameter_inc:parameter_end
            ...
            if strcmp(parameter, 'Gaussian')
                ...
                networkStats_opt = mxw.networkActivity.computeNetworkStats_JL(networkAct_opt, threshold_fn, thresholdBurst_opt, 'MinPeakDistance', minPeakDistance_opt);
            ...
            elseif strcmp(parameter, 'Threshold')
                ...
                networkStats_opt = mxw.networkActivity.computeNetworkStats_JL(networkAct_opt, 'Threshold', k, 'MinPeakDistance', minPeakDistance_opt);
            elseif strcmp(parameter, 'FixedThreshold')
                networkAct_opt = mxw.networkActivity.computeNetworkAct(networkData, 'BinSize', binSize_opt,'GaussianSigma', gaussianSigma_opt);
                networkStats_opt = mxw.networkActivity.computeNetworkStats_JL(networkAct_opt, 'FixedThreshold', k, 'MinPeakDistance', minPeakDistance_opt);
            ...
            elseif strcmp(parameter, 'MinPeakDistance')
                networkAct_opt = mxw.networkActivity.computeNetworkAct(networkData, 'BinSize', binSize_opt,'GaussianSigma', gaussianSigma_opt);
                networkStats_opt = mxw.networkActivity.computeNetworkStats_JL(networkAct_opt, threshold_fn, thresholdBurst_opt, 'MinPeakDistance', k);
            end

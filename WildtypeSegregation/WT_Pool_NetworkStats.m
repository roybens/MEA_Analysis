...
%PATH DIV0 CHIPS DIVOPt REFFILE
...
%Iterate through the different projects.< eg CHD8 and ADNP>
for k = 1 : length(ProjectFilePaths)
    ...
    folderstmp = strsplit(ProjectFilePaths{k},filesep);
    projectName = folderstmp{end-1};
    opDir = '/home/mmp/Documents/wildtype_seg/';
...
% Duplicate the project name for the specified number of rows
Project = repmat({projectName}, length(Run_ID), 1);
% make table
